...
export class AffiliateStatControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: AffiliateStat })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Query() query: {},
    @common.Body() data: AffiliateStatCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [AffiliateStat] })
  ...
  async findOne(
    @common.Query() query: {},
    @common.Param() params: AffiliateStatWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
